...
public class ModularAxe extends Item {
        ...
        if (sup.isPresent() && shup.isPresent()) {
            AttributeModifiersComponent yoShat = AttributeModifiersComponent.builder()
                    .add(
                            ...
                            new EntityAttributeModifier(Identifier.ofVanilla("base_attack_damage"), (sup.get().axeDamage+shup.get().axeDamage), EntityAttributeModifier.Operation.ADD_VALUE),
